...
<header id="home" class="welcome-hero" style="background-color: rgb(34,34,34);">
    ...
    <div class="top-area" tyle="background-color: rgb(34,34,34);">
        ...
        <section class="bg0 p-t-75 p-b-120" style="background-color: rgb(34,34,34);left:10px">
            <div class="container" style="background-color: rgb(34,34,34); left:10px">

                <div class = "main-wrapper" style="background-color: rgb(34,34,34);">
                    <div class = "container">
                        <div class = "main-title">
                            <h1 style="color:#FFA900">Violins List</h1>
                        </div>

                        <div class = "item-list" style="left:40px">
                            <?php
