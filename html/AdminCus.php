...
<header id="home" class="welcome-hero" style="background-color: rgb(34,34,34);">
    ...
    <div class="table-responsive table--no-card m-b-40" style="background-color: rgb(34,34,34);">
        <table class="table table-borderless table-striped table-earning" style="background-color: rgb(34,34,34);">
            <thead>
            <tr>
                <th style="color:#000000;background-color:#FFA900">Customer ID</th>
                <th style="color:#000000;background-color:#FFA900">Customer Name</th>
                <th style="color:#000000;background-color:#FFA900">Customer Address</th>
                <th style="color:#000000;background-color:#FFA900">Customer Email</th>
                <th style="color:#000000;background-color:#FFA900">Customer Visa ID</th>
            ...
            while($row=mysqli_fetch_array($query_run)){
                ...
                <tr>
                    ...
                    <td style="color:#FFA900;"><?php echo $row['user_name'] ?></td>
                    <td style="color:#FFA900;"><?php echo $row['user_add'] ?></td>
                    <td style="color:#FFA900;" ><?php echo $row['user_email'] ?></td>
                    <td style="color:#FFA900;"><?php echo $row['visa_id'] ?></td>
                </tr>
                <?php
