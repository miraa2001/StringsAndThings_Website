...
<header id="home" class="welcome-hero">
    ...
    <!-- For YourInformation  page content-->
                ...
                <section id="populer-products" class="populer-products" style="background-color: rgb(34,34,34);">
                    <div class="container" style="background-color: rgb(34,34,34);">

                        <div class="containerDep p-t-40" style="background-color: rgb(34,34,34);">

                            <h3 class="title" style="color:#FFA900;"> System Information: </h3>

                            <div class="products-container" style="background-color: rgb(34,34,34);">
                                <a href="AdminCus.php">
